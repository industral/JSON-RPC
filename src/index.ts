import {IRequestParameter} from './types.js';
...
export default class JSON_RPC {
    ...
    constructor({url, jsonrpc = '2.0', fetchObject}) {
        this.url = url;
     ...
     */
    public async calls(params: IRequestParameter | IRequestParameter[]): Promise<any> {
